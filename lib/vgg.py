...
class VGG(nn.Module):
    ...
    VGG model
    '''
    def __init__(self, features, num_classes=10, fc_size=512):
...
def vgg16_bn(in_channels=3, num_classes=10, fc_size=512):
    """VGG 16-layer model (configuration "D") with batch normalization"""
    return VGG(make_layers(cfg['D'], batch_norm=True, in_channels=in_channels), num_classes=num_classes, fc_size=fc_size)
